...
<?php
	if(isset($_POST['register'])){
		...
		move_uploaded_file($u_image_tmp,"user_images/$u_username-$u_image");
		...
		if($check_email == 1){
			...
			$insert_user = "insert into user (u_name, u_email, u_username, u_pass, u_birthday, u_location, u_gender, u_image) values ('$u_name','$u_email','$u_username','$u_pass','$date_value','$u_location','$u_gender','$u_username-$u_image')";
